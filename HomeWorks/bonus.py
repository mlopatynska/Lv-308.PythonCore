...
print((rad-1)**2 + rad**2)
is_pandigit = sorted(str(input("Write yor digits: ")))
pandigit = sorted(str(1234567890))
# IDK, how to do it properly without IF statement
print(len(pandigit) == len(list(set(is_pandigit).intersection(set(pandigit)))))
